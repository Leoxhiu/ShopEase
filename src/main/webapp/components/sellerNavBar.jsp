...
<head>
    ...
    <style>
        <%@ include file="../css/sellerNavBar.css"%>
    </style>
...
<div class="navigation_bar">
    <nav class="shadow-sm navbar navbar-expand-lg d-flex">
        <div class="container">
            <a class="navbar-brand font-tertiary brand-text" href="<%= JspPage.SELLER_HOME.getUrl() %>">ShopEase</a>
            ...
            <div class="collapse navbar-collapse"  id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item main-item">
                        <a class="nav-link nav-direct" aria-current="page" href="<%= JspPage.SELLER_HOME.getUrl() %>">Home</a>
                    </li>
                    <li class="nav-item main-item">
                        <a class="nav-link nav-direct" href="<%= JspPage.SELLER_MARKET.getUrl() %>">Market</a>
                    </li>
                </ul>
