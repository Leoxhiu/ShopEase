...
<head>
    ...
    <title>ShopEase - Add Admin</title>

    <%--    main css file--%>
    <style>
        <%@ include file="../css/adminAddAdmin.css"%>
    </style>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="<%= ServletPage.ADMIN_ADD_ADMIN.getUrl() %>" method="post" enctype="multipart/form-data">
                            <h2 class="h5 mb-4 font-bold font-primary">Admin Registration</h2>
                            <div class="mb-3">
                                <label for="profile" class="form-label">Profile</label>
                                <input class="form-control" id="profile" name="profile" type="file" accept="image/*" required>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="email" name="email" type="email" placeholder="example@gmail.com" required value="${email}">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="text-end">
                                <button class="btn btn-primary mt-2 animate-up-2" type="submit">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
