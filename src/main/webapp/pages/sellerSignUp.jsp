...
<head>
    ...
    <title>ShopEase - Join as Seller</title>

    <%--    main css file--%>
    <style>
        <%@ include file="../css/sellerSignUp.css"%>
    </style>
        ...
        <div class="container">
            <div class="row justify-content-evenly">
                ...
                <div class="col-lg-7 d-flex align-items-center justify-content-center">
                    <%@include file="../images/others/businessDeal.svg" %>
                </div>
                        ...
                        <div class="col-12 d-flex align-items-center justify-content-center main-form">
                            <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                                <div class="text-center text-md-center mb-4 mt-md-0">
                                    <h3 class="mb-0 font-bold font-secondary">Join as Seller</h3>
                                </div>
