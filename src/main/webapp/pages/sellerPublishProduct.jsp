...
<head>
    ...
    <title>ShopEase - Publish Product</title>

    <%--    main css file--%>
    <style>
        <%@ include file="../css/sellerPublishProduct.css"%>
    </style>
    ...
    <%--    main script file--%>
    <script>
        <%@ include file="../js/sellerPublishProduct.js"%>
    </script>
</head>
<body>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="<%= ServletPage.SELLER_PUBLISH_PRODUCT.getUrl() %>" method="post" enctype="multipart/form-data">
                            <h2 class="h5 mb-4 font-bold font-primary">Product Information</h2>
                            <div class="mb-3">
                                <label for="productImage" class="form-label">Product Image</label>
                                <input class="form-control" id="productImage" name="productImage" type="file" accept="image/*" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="text-end">
                                <button class="btn btn-primary mt-2 animate-up-2" type="submit">Create Product</button>
                            </div>
                        </form>
                    </div>
                </div>
