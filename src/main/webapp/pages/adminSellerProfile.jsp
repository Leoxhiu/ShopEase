...
<main>
    <div class="container">
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="<%= ServletPage.ADMIN_SELLER_PROFILE.getUrl() +"?id=" + request.getAttribute("id") %>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="status" name="status" aria-label="Status select example" required>
                                        <option value="0" ${status eq '0' ? 'selected' : ''}>Not Approved</option>
                                        <option value="1" ${status eq '1' ? 'selected' : ''}>Approved</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="sellerBankAccount" name="sellerBankAccount" type="text" placeholder="Bank account" value="${sellerBankAccount}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="unit" name="unit" type="text" placeholder="No." value="${unit}">
                                    </div>
                                </div>
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        <label for="address">Address</label>
                                        <input class="form-control" id="address" name="address" type="text" placeholder="Enter your home address" value="${address}">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="city" name="city" type="text" placeholder="City" value="${city}">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="state">State</label>
                                        <select class="form-select" id="state" name="state" aria-label="State select example">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="postal" name="postal" type="tel" placeholder="Postal" value="${postal}">
                                    </div>
                                </div>
                            </div>
                            <div class="text-end">
        ...
        <jsp:include page="/components/confirmationModal.jsp">
            <jsp:param name="formDirect" value="<%= ServletPage.ADMIN_DELETE_SELLER.getUrl() +"?id=" + request.getAttribute("id") %>"/>
        </jsp:include>
    </div>
</main>
</body>
