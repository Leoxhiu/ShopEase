...
<head>
    ...
    <%--    main css file--%>
    <style>
        <%@ include file="../css/adminCustomerProfile.css"%>
    </style>
...
<main>
    <div class="container">
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="<%= ServletPage.ADMIN_CUSTOMER_PROFILE.getUrl() +"?id=" + request.getAttribute("id") %>" method="post" enctype="multipart/form-data">
        ...
        <jsp:include page="/components/confirmationModal.jsp">
            <jsp:param name="formDirect" value="<%= ServletPage.ADMIN_DELETE_CUSTOMER.getUrl() +"?id=" + request.getAttribute("id") %>"/>
        </jsp:include>
    </div>
</main>
</body>
